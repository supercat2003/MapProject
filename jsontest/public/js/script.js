...
window.onload = async function () {
    ...
    const response = await fetch(
        'http://127.0.0.1:30511/api/S1v1ANDS2v1');
        ...
        onChange: async function (data) {
            ...
            if (data.from === 0 && data.to === 1) {
                ...
                const responseS2 = await fetch(
                    'http://127.0.0.1:30511/api/S2v1ANDS3v1');
                ...
                const responseS3 = await fetch(
                    'http://127.0.0.1:30511/api/S3v1ANDS4v1');
                ...
                const responseS4 = await fetch(
                    'http://127.0.0.1:30511/api/u1S1v1');
                ...
                const responseS5 = await fetch(
                    'http://127.0.0.1:30511/api/u1S2v1');
                ...
                const responseS6 = await fetch(
                    'http://127.0.0.1:30511/api/u1S3v1');
    ...
    const response2 = await fetch(
        'http://127.0.0.1:30511/api/S1v2ANDS2v2');
    ...
    $("#demo_1").ionRangeSlider({
        ...
        onChange: async function (data1) {
            ...
            if (data1.from === 0 && data1.to === 1) {
                ...
                const responseS1 = await fetch(
                    'http://127.0.0.1:30511/api/S2v2ANDS3v2');
                const dataS1 = await responseS1.json();
                length = dataS1.length;
                ...
                const responseS1 = await fetch(
                    'http://127.0.0.1:30511/api/S1v3ANDS4v2');
                const dataS1 = await responseS1.json();
                length = dataS1.length;
                ...
                const responseS1 = await fetch(
                    'http://127.0.0.1:30511/api/u1S1v22');
                const dataS1 = await responseS1.json();
                length = dataS1.length;
                ...
                const responseS1 = await fetch(
                    'http://127.0.0.1:30511/api/u1S3v2');
                const dataS1 = await responseS1.json();
                length = dataS1.length;
                ...
                const responseS1 = await fetch(
                    'http://127.0.0.1:30511/api/u1S2v2');
                const dataS1 = await responseS1.json();
                length = dataS1.length;
    ...
    for (let i = 0; i < inputH.length; i++) {
        ...
        if (selectedOption3 === 'one') {
            if (selectedOption2 === 'mar') {
                ...
                fetch('http://127.0.0.1:30511/api/u1S1v1', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                ...
                fetch('http://127.0.0.1:30511/api/u1S2v1', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                fetch('http://127.0.0.1:30511/api/u1S3v1', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                fetch('http://127.0.0.1:30511/api/S4v1', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
            ...
            if (selectedOption2 === 'mar') {
                ...
                fetch('http://127.0.0.1:30511/api/u1S1v22', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                fetch('http://127.0.0.1:30511/api/u1S2v2', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                fetch('http://127.0.0.1:30511/api/u1S3v2', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                fetch('http://127.0.0.1:30511/api/S4v2', {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                        'Content-Type': 'application/json'
